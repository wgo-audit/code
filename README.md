...
report-repository importer or index generator. The upload PR changes only the
new `audits/<subject>/<cutoff>/` destination; report-repository indexes are
regenerated by that repository's own post-merge workflow.
