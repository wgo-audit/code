...
class SkillContractTests(unittest.TestCase):
    ...
    def test_upload_is_a_verify_only_publication_workflow(self) -> None:
        ...
        self.assertIn("A WGO upload PR is destination-only", workflow)
        self.assertIn("post-merge responsibility", workflow)
        self.assertIn("incompatible with pull-less upload", workflow)
